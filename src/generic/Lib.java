...
public class Lib implements IAutoConstant {
	...
	public static void captureScreeshot(WebDriver driver, String testMethodeName) {
		...
		try {
			...
			File destFile = new File(SCREENSHOT_PATH + testMethodeName+"__"+currDateAndTime+".png");
